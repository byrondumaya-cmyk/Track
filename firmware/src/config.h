...
#define UPLOAD_FAIL_REBOOT_LIMIT 10   // Reboot after N consecutive upload failures
...
#define DIAG_AP_PASS    "GTrack@2026!"  // WPA2 — change via portal or reflash
...
#define PORTAL_SESSION_TIMEOUT_MS (30UL * 60 * 1000) // 30-minute session idle timeout
